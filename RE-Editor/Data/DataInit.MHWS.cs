...
public static partial class DataInit {
    ...
    private static void LoadDicts() {
        ...
        DataHelper.ARTIAN_INFO_LOOKUP_BY_GUID           = LoadDict<Global.LangIndex, Dictionary<Guid, string>>(Assets.ARTIAN_INFO_LOOKUP_BY_GUID);
        DataHelper.DECORATION_INFO_LOOKUP_BY_ENUM_VALUE = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.DECORATION_INFO_LOOKUP_BY_ENUM_VALUE);
        ...
        DataHelper.ENEMY_NAME_LOOKUP_BY_ENUM_VALUE      = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.ENEMY_NAME_LOOKUP_BY_ENUM_VALUE);
        ...
        DataHelper.MEDAL_NAME_LOOKUP_BY_ENUM_VALUE      = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.MEDAL_NAME_LOOKUP_BY_ENUM_VALUE);
        DataHelper.MEDAL_INFO_LOOKUP_BY_GUID            = LoadDict<Global.LangIndex, Dictionary<Guid, string>>(Assets.MEDAL_INFO_LOOKUP_BY_GUID);
        DataHelper.PENDANT_NAME_LOOKUP_BY_ENUM_VALUE    = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.PENDANT_NAME_LOOKUP_BY_ENUM_VALUE);
        DataHelper.PENDANT_INFO_LOOKUP_BY_GUID          = LoadDict<Global.LangIndex, Dictionary<Guid, string>>(Assets.PENDANT_INFO_LOOKUP_BY_GUID);
        DataHelper.QUEST_INFO_LOOKUP_BY_ENUM_VALUE      = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.QUEST_INFO_LOOKUP_BY_ENUM_VALUE);
        ...
        DataHelper.WEAPON_SERIES_BY_ENUM_VALUE          = LoadDict<Global.LangIndex, Dictionary<int, string>>(Assets.WEAPON_SERIES_BY_ENUM_VALUE);
